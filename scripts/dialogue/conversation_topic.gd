...
static func local_news(text: String = "What's been happening around here?") -> ConversationTopic:
	var topic := ConversationTopic.new()
	topic.topic_type = TopicType.LOCAL_NEWS
	topic.display_name = "Local News"
	topic.menu_text = text
	return topic

## Create a rumors topic
static func rumors(text: String = "Heard any interesting rumors?") -> ConversationTopic:
	var topic := ConversationTopic.new()
...
static func personal(text: String = "Tell me about yourself.") -> ConversationTopic:
	var topic := ConversationTopic.new()
...
static func directions(text: String = "Can you give me directions?") -> ConversationTopic:
	var topic := ConversationTopic.new()
...
static func trade(text: String = "What can you tell me about trade here?") -> ConversationTopic:
	var topic := ConversationTopic.new()
...
static func weather(text: String = "How's the weather been?") -> ConversationTopic:
	var topic := ConversationTopic.new()
...
static func quests(text: String = "Looking for any help around here?") -> ConversationTopic:
	var topic := ConversationTopic.new()
...
static func goodbye(text: String = "Farewell.") -> ConversationTopic:
	var topic := ConversationTopic.new()
