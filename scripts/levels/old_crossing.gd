## old_crossing.gd - Junction village between regions
extends Node3D

const ZONE_ID := "village_old_crossing"
...
func _ready() -> void:
	...
	_setup_navigation()
	print("[Old Crossing] Junction village loaded")


func _create_terrain() -> void:
	var ground_mat := StandardMaterial3D.new()
	ground_mat.albedo_color = Color(0.42, 0.4, 0.35)
...
func _spawn_fast_travel_shrine() -> void:
	FastTravelShrine.spawn_shrine(self, Vector3(0, 0, 0), "Old Crossing Shrine", "old_crossing_shrine")
